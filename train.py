...
class picture_train():
    def __init__(self,train_txt,test_txt,batch_size,epoch,lr,result_path,out_features,model_type):
        ...
        with open(files_path, 'w') as f:
            ...
            for i in range(epoch):
                ...
                with torch.no_grad():
                    ...
                    write.add_scalar("train_accuracy", total_test_accuracy/test_dataset_len, i)
                print("{}/{} Epoch ---> train_loss:{}  train_accuracy:{}  test_loss:{}  test_accuracy:{}".format(i+1,epoch,total_train_loss,total_train_accuracy/train_dataset_len,total_test_loss,total_test_accuracy/test_dataset_len))
                f.write("{}/{} Epoch ---> train_loss:{}  train_accuracy:{}  test_loss:{}  test_accuracy:{}".format(i+1,epoch,total_train_loss,total_train_accuracy/train_dataset_len,total_test_loss,total_test_accuracy/test_dataset_len)+'\n')
            #  保存模型
