...
class Test():
    def __init__(self,model_path,img_path,picture_size,out_features):
...
if __name__ == '__main__':
    ...
    img_path = r'D:\python\pycharm project\pytorch_learn\picutre_classification\test_picutre\capsicum_1.png'
